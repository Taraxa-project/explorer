...
function DAG({ dagBlocks, pbftBlocks, reverse, history, highlight }) {
  ...
  let onFinalized = useCallback(
    (dt) => {
      dag_events.onFinalized(
        history,
        dt,
        lastOrderX,
        lastDagX,
  ...
  let onSchedule = useCallback(
    (dt) => {
      dag_events.onSchedule(
        history,
        dt,
        prevPeriodLastHash,
        pauseNextAnimation,
